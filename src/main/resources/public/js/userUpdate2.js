...
commentCreateBtn.addEventListener("click",function () {
    ...
    $.ajax({
        type: "POST",
        url: "/user/"+id+"/update",  // Spring Boot 어플리케이션의 URL로 변경
        ...
        success: function(response) {
            ...
            const msg =  "회원수정이 완료 되었습니다"
            alert(msg);
            window.location.href = "/bangbang/myPage";
        },
        error: function(error) {
            ...
            window.location.href = "/bangbang/user/"+id+"/update";
        }
    });
